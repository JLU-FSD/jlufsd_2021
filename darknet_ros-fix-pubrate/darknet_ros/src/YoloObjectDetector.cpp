...
void YoloObjectDetector::init()
{
  ...
  objectPublisher_ = nodeHandle_.advertise<std_msgs::Int8>(objectDetectorTopicName,
                                                           ...
                                                           objectDetectorLatch);
  boundingBoxesPublisher_ = nodeHandle_.advertise<auto_msgs::BoundingBoxes>(
...
void YoloObjectDetector::checkForObjectsActionGoalCB()
{
  ...
  boost::shared_ptr<const auto_msgs::CheckForObjectsGoal> imageActionPtr =
...
void *YoloObjectDetector::publishInThread()
{
  ...
  if (num > 0 && num <= 100) {
    ...
    for (int i = 0; i < numClasses_; i++) {
      if (rosBoxCounter_[i] > 0) {
        auto_msgs::BoundingBox boundingBox;
  ...
  if (isCheckingForObjects()) {
    ...
    auto_msgs::CheckForObjectsResult objectsActionResult;
