...
// Actions.
#include <auto_msgs/CheckForObjectsAction.h>

typedef actionlib::SimpleActionClient<auto_msgs::CheckForObjectsAction> CheckForObjectsActionClient;
...
auto_msgs::BoundingBoxes boundingBoxesResults_;
...
void checkForObjectsResultCB(
    ...
    const auto_msgs::CheckForObjectsResultConstPtr& result) {
...
bool sendImageToYolo(ros::NodeHandle nh, const std::string& pathToTestImage) {
  ...
  // Generate goal.
  auto_msgs::CheckForObjectsGoal goal;
  goal.image = *image;
