...
class LidarPerception{
    ...
    //void removal_callback(const sensor_msgs::PointCloud2ConstPtr& in_cloud);
...
//聚类
    ...
    ec.setClusterTolerance(0.1);   //搜索半径，
    ...
    for(std::vector<pcl::PointIndices>::const_iterator it=cluster_indices.begin();it!=cluster_indices.end();++it){
       ...
       //转到imu坐标系
        ...
        else if(output_point_cone.position.z>0.3)
        {
